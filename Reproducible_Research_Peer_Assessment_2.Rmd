...
questions about severe weather events.The following questions will be answered:
...
Plot the graph using ggplot for total Fatalities & Injuries By Event Type. Here, a bar plot is
used to display the top 10 most event types most detrimental to injuries & fatalities.
```{r}
...
Based on the data from the "NATIONAL WEATHER SERVICE INSTRUCTION 10-1605" partnered with this assignment, the values provided for Property Damage and Crop Damage will be converted as 
required. (This publication is available at http://www.nws.noaa.gov/directives/)
```{r}
